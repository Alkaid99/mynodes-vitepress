       ...
       '/mysql/': [
        {
          ...
          text: '介绍',
          items: [
            { text: '数据库简介', link: '/mysql/01.数据库简介.md' },
            { text: 'SQL 简介', link: '/mysql/02.SQL简介.md' },
            { text: 'MySQL 简介', link: '/mysql/03.mysql简介.md' },
            { text: 'MySQL 约束', link: '/mysql/04.mysql约束.md' },
            { text: 'SQL 基本命令', link: '/mysql/04.SQL基础命令.md' },
          ],
        },
        {
          collapsed: true,
          text: 'MySQL 命令',
          items: [
            { text: 'DDL', link: '/mysql/05.Mysql基本操作-DDL.md' },
            { text: 'DML', link: '/mysql/06.Mysql基本操作-DML.md' },
            { text: 'DQL', link: '/mysql/07.Mysql基本操作-DQL.md' },
            { text: 'DCL', link: '/mysql/08.Mysql基本操作-DCL.md' },
          ],
        },
      ]
    },
